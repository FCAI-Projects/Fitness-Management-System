...
<div class="container mx-auto" style="width: 400px;margin-top: 280px">
    <form method="post" action="<?php echo URLROOT ?>/admin/addpackage">
        ...
        <div class="form-group">
            ...
            <input type="number" name="range" class="form-control" id="maxNumber" aria-describedby="emailHelp" min="1" value="<?php echo $data['range']?>" required>
        </div>
